...
namespace CriticalChainAddIn.Utils
{
    public static class IEnumerableExtensions
    {
        ...
        private static IDictionary<T, PathInfo<T>> ToPathInfoDictionary<T>(this IEnumerable<T> list, Func<T, IEnumerable<T>> predecessorSelector, Func<T, IEnumerable<T>> sucessorSelector) => list.ToDictionary(
            item => item,
    ...
    public class Activity
    {
        ...
        /// </summary>
        public ICollection<Activity> Predecessors { get; }
